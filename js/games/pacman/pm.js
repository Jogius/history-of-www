...
pacman.engine = {
    ...
    showResultView: function(msg) {
        pacman.engine.newGame(pacman.model.username)
        //document.getElementById("result-msg").innerHTML = msg;
        //var tableElement = document.getElementById("score-table");
        //var html = "<tr> <td><h3>Name</h3></td> <td><h3>Score</h3></td> <td><h3>Ticks</h3></td> </tr>";
        //
    ...
    tick: function() {
        ...
        if (status === pacman.engine.magic.CONTINUE) {
            ...
            pacman.engine.showResultView("Game Over! Du hast " + pacman.model.points + " Punkte erspielt.");
        } else if (status === pacman.engine.magic.VICTORY) {
            pacman.model.addEntry();
            pacman.engine.showResultView("Gewonnen! Du hast " + pacman.model.points + " Punkte erspielt.");
        }
